...
describe('complexOperation - Unit Tests', () => {
  ...
  describe('calculateArea', () => {
    ...
    it('sixth test figure is rectangle and number1 and number2 are numbers', () => {
      expect(complexOperations.calculateArea('rectangle', 5, 3)).toBe(15);
    });
  ...
  describe('sumGratherThan', () => {
    ...
    it('fifth test number3 is greater than number1 and number2 together', () => {
      expect(complexOperations.sumGratherThan(10, 10, 54)).toBe('20 is less than 54'); 
    });
  ...
  describe('numberOfOddAndEvenNumbers', () => {
    ...
    it('forth test enter even numbers in array', () => {
      expect(complexOperations.numberOfOddAndEvenNumbers([2,4,6,8])).toStrictEqual({odd: 0, even: 4});
    });
    it('fifth test enter odd numbers in array', () => {
      expect(complexOperations.numberOfOddAndEvenNumbers([1,3,5,7,9])).toStrictEqual({odd: 5, even: 0});
    });
